...
export function getControlPosition(e: MouseTouchEvent, touchIdentifier: number | void, draggable: Draggable): ControlPosition | void {
...
export function createCoreData(draggable: Draggable, x: number, y: number): DraggableData {
